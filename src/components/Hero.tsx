...
export const Hero = () => {
  ...
  <div className='bg-[#54A6FF] w-full sm:w-[720px] h-[360px] mx-4 sm:mx-[28px] rounded-md'>
  ...
  <div className='bg-[#3563E9] w-full sm:w-[720px] h-[360px] rounded-md mx-4 sm:mx-[28px]'>
