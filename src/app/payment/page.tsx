          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                ...
                <Link href="/admin">
                <button className="bg-blue-600 text-white px-4 py-2 rounded w-full sm:w-auto">Rent Now</button>  </Link>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-center mb-4 w-full h-auto">
              <Image
                ...
                width={200}
                height={120}
                className="w-full h-auto object-cover rounded mr-4"
              />
              <div>
                <h3 className="font-semibold">Nissan GT - R</h3>
                <p className="text-yellow-500">
                  <i className="fas fa-star"></i> <i className="fas fa-star"></i> <i className="fas fa-star"></i> <i className="fas fa-star"></i> <i className="fas fa-star-half-alt"></i> 440+ Reviewer
                </p>
              </div>
            </div>
